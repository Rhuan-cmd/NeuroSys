function save_init() {
    ...
    if (!variable_global_exists("op_auto_config_feita")) global.op_auto_config_feita = true;
...
function save_carregar() {
    ...
    global.op_pixel_perfect_nivel = clamp(ini_read_real("config", "pixel_perfect_nivel", global.op_pixel_perfect ? 1 : 0), 0, 2);
    global.op_pixel_perfect = global.op_pixel_perfect_nivel > 0;
...
function save_escrever() {
    ...
    ini_write_real("config", "pixel_perfect_nivel", variable_global_exists("op_pixel_perfect_nivel") ? global.op_pixel_perfect_nivel : 2);
    ini_write_real("config", "auto_config_feita", variable_global_exists("op_auto_config_feita") && global.op_auto_config_feita ? 1 : 0);
    ini_write_real("config", "resolucao", variable_global_exists("op_resolucao") ? global.op_resolucao : 1);
