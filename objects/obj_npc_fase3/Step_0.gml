...
if (atualizar_felicidade > 0){
	...
	if (idbackground){
		switch (estado_felicidade){
			case 0:
				layer_background_sprite(idbackground, spr_fundo_fase3_feliz);
				break;
				
			case 1:
				layer_background_sprite(idbackground, spr_fundo_fase3_serio);
				break;
				
			case 2:
				layer_background_sprite(idbackground, spr_fundo_fase3_triste);
				break;
		}
	}
	...
	layer_background_sprite(idbackground, spr_fundo_fase3_morte);
	perdeu = true;
}
