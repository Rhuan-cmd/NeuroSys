...
chiado_audio = -1;
audio_play_sfx(snd_f2_entrada, 4, false, 0.52);
...
iniciar_minigame = function() {
    ...
    audio_play_sfx(snd_f2_clique, 3, false, 0.5);
    audio_play_sfx(snd_f2_suspense, 4, false, 0.76);
...
congelar_cursor = function() {
    ...
    audio_play_sfx(snd_f2_congelar, 4, false, 0.72);
};
...
repelir_cursor = function() {
    ...
    audio_play_sfx(snd_f2_repelir, 4, false, 0.78);
};
...
ativar_minigame = function() {
    ...
    shake_impacto = 22;
    shake_inicio = 1.8;
    audio_play_sfx(snd_f2_fuga, 2, false, 0.52);
    audio_play_sfx(snd_f2_tremor, 3, false, 0.36);
};
...
perder_vida = function() {
    vidas--;
    audio_play_sfx(snd_f2_dano, 3, false, 0.72);
    audio_play_sfx(snd_f2_tremor, 3, false, min(0.82, 0.42 + (vidas_max - vidas) * 0.08));
    timer_clique = 0;
...
finalizar_jogo = function(_vitoria) {
    ...
    audio_play_sfx(snd_f2_saida, 4, false, 0.56);
    audio_play_sfx(_vitoria ? snd_f2_vitoria : snd_f2_derrota, 4, false, _vitoria ? 0.96 : 0.82);
    if (_vitoria) {
