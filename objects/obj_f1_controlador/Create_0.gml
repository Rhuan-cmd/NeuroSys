...
ambiente_audio = audio_play_music(snd_f1_musica, 1, true, 0.68);
...
aplicar_dano = function() {
    if (escudo > 0) {
        ...
        audio_play_sfx(snd_f2_dano, 3, false, 0.62);
    }
    combo = 0;
};
...
finalizar_fase = function(_venceu) {
    ...
    audio_stop_sound(snd_f1_musica);
    audio_stop_sound(snd_f1_tensao);
    audio_play_sfx(_venceu ? snd_f2_vitoria : snd_f2_derrota, 4, false, 0.78);
    if (_venceu) {
