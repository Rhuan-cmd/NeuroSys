...
if (estado == 2) {
    ...
    draw_rectangle(731, 202, 824, 222, false);
    draw_rectangle(731, 274, 824, 294, false);
...
if (estado == 3 || estado == 4) {
    ...
    draw_sprite_ext(spr_f2_painel_resultado, final_vitoria ? 0 : 1, 480, 270 + _final_offset, _final_pop, _final_pop, 0, c_white, _final_suave);
    ...
    draw_text(480, 156 + _final_offset, final_vitoria ? "ataques contidos com responsabilidade" : "a rede precisa de uma nova tentativa");
    draw_set_halign(fa_center);
    draw_set_color(make_color_rgb(116, 231, 255));
    draw_set_halign(fa_left);
