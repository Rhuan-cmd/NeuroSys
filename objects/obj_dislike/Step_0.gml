...
// Aumenta o contador do ângulo
tempo_oscilacao += frequencia;

// Calcula a nova posição Y
// dsin(tempo_oscilacao) retorna um valor entre -1 e 1
// Multiplicamos pela amplitude para aumentar o tamanho da onda
y = y_ancora + dsin(tempo_oscilacao) * amplitude;
