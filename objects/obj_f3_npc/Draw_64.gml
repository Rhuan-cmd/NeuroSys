...
if (_corrupcao > 0) {
	...
	draw_sprite_ext(spr_fx_corrupcao, _frame, 0, 0, display_get_gui_width() / sprite_get_width(spr_fx_corrupcao), display_get_gui_height() / sprite_get_height(spr_fx_corrupcao), 0, c_white, (0.12 + _corrupcao * 0.36) * _fx_brilho);
}
