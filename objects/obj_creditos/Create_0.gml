...
creditos = [
    ...
    { texto: "Tudo começou em uma tela aparentemente comum. Entre postagens, notificações e conversas rápidas, palavras cruéis passaram a se repetir até parecerem parte da paisagem digital.#Mas nenhuma mensagem desaparece somente porque a janela foi fechada. Do outro lado da tela existe alguém que sente o peso de cada comentário, de cada ataque e de cada silêncio.", cor: c_white, escala: 0.92, espaco: 150 },
    { texto: "FASE 1  INTERROMPER", cor: make_color_rgb(255, 232, 138), escala: 1.18, espaco: 42 },
    ...
    { texto: "FASE 2  RESISTIR", cor: make_color_rgb(255, 232, 138), escala: 1.18, espaco: 42 },
    ...
    { texto: "FASE 3  PROTEGER", cor: make_color_rgb(255, 232, 138), escala: 1.18, espaco: 42 },
    { texto: "Na terceira fase, a história revelou seu centro: uma pessoa cercada por hostilidade. O escudo não era apenas uma barreira. Ele simbolizava apoio, presença e a coragem de agir quando alguém precisa de ajuda.#Cada mensagem bloqueada mostrou que a rede também pode ser ocupada por cuidado. Uma resposta responsável, uma denúncia e uma conversa acolhedora podem mudar o rumo de uma história.", cor: c_white, escala: 0.92, espaco: 150 },
    { texto: "FASE 4  CONFRONTAR", cor: make_color_rgb(255, 232, 138), escala: 1.18, espaco: 42 },
    ...
    { texto: "Ao interromper esse ciclo, você não apagou o que aconteceu. Mas abriu espaço para outra possibilidade: uma internet em que responsabilidade e empatia não sejam exceções.#A história termina aqui, mas a escolha continua fora do jogo. Antes de comentar, compartilhar ou permanecer em silêncio, lembre-se de que sempre existe alguém do outro lado da tela.", cor: make_color_rgb(172, 224, 255), escala: 0.96, espaco: 164 },
    ...
    { texto: "Hugo Oliveira Silva#Rhuan Gabriel Moura Brasilino", cor: c_white, escala: 1, espaco: 92 },
