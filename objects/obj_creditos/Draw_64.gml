...
if (_fx_qualidade > 0) {
    var _star_step = _fx_qualidade == 1 ? 2 : 1;
    for (var _i = 0; _i < 10; _i += _star_step) {
        var _sx = (_i * 83 + timer * (0.24 + (_i mod 3) * 0.08)) mod (_w + 80) - 40;
        var _sy = 40 + ((_i * 47) mod (_h - 80));
        draw_set_alpha((_fx_qualidade == 1 ? 0.07 : 0.12) + ((_i mod 4) * 0.035));
...
if (_fx_qualidade > 0) {
    var _mem_step = _fx_qualidade == 1 ? 4 : 2;
    for (var _m = 0; _m < array_length(memorias); _m += _mem_step) {
